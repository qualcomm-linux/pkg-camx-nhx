...
This repository has debian packaging rules and scripts for [prebuilt CamX camera nhx binaries](https://qartifactory-edge.qualcomm.com/ui/native/qsc_releases/software/chip/component/camx.qclinux.0.0/) for the Hamoa platform.
...
1. Install the camera dev package:
    - `sudo dpkg -i camx-nhx_<version>_arm64.deb`
...
pkg-camx-dev is licensed under the [BSD-3-Clause license](https://spdx.org/licenses/BSD-3-Clause.html). See [LICENSE.txt](LICENSE.txt) for the full license text.
